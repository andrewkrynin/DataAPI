...
export default function DocsPage() {
  const quickAccess = [
    ...
    },
    {
      ...
      href: "/docs/guides",
      sublinks: [
        { label: "ChatGPT Setup", href: "/docs/guides/chatgpt" },
        { label: "Claude Setup", href: "/docs/guides/claude" },
        { label: "LangChain Integration", href: "/docs/guides/langchain" },
      ],
    },
    {
      title: "LLMS.txt",
    ...
    },
    {
      ...
      sublinks: [
        ...
        { label: "Billing & Credits", href: "/billing" },
      ],
    },
  ];
